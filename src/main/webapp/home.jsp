...
<body>
  ...
  <div class="dropdown position-fixed bottom-0 end-0 mb-3 me-3 bd-mode-toggle">
    <button class="btn btn-bd-primary py-2 dropdown-toggle d-flex align-items-center" id="bd-theme" type="button"
      ...
      <span class="visually-hidden" id="bd-theme-text">Trocar tema</span>
    </button>
  ...
  <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">Fintech</a>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
        <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
          ...
          <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="sidebarMenuLabel">Fintech</h5>
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <h2>Últimas transações do mercado</h2>
          ...
          <table class="table table-striped table-sm">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>Confirmada</td>
                <td>30 ações - XYZ Ltda</td>
                <td>Bolsa de Valores</td>
              </tr>
              <tr>
                <td>1,007</td>
                <td>Venda de Bitcoin</td>
                <td>Completa</td>
                <td>0.3 BTC</td>
                <td>Exchange</td>
              </tr>
